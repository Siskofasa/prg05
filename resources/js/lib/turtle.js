...
(function () {
    ...
    render = function () {
        ...
        TurtleGraphics.canvasLib[TurtleGraphics.defaults.canvasID].clearRect(llx, lly, (urx - llx), (ury - lly));
    ...
    Turtle.prototype.dot = function () {
        ...
        if (!this.context.animate) {
            ...
            this.context.fillRect(
                this.context.position[0] - size / 2,
                this.context.position[1] - size / 2, size, size
            );
...
//
    ...
    function clear_canvas(canId) {
        const documentContext = document.getElementById(canId).getContext('2d');
        if (arguments.length >= 2) {
//		fillStyle = arguments[1];
//		fillRect(0, 0, canvas.width, canvas.height);
        }
        documentContext.clearRect(
            -documentContext.canvas.width / 2,
            -documentContext.canvas.height / 2,
            documentContext.canvas.width,
            documentContext.canvas.height
        );
    }
