...
/***/ "./resources/js/parsons_problems/swap_page.js":
/*!****************************************************!*\
  !*** ./resources/js/parsons_problems/swap_page.js ***!
  \****************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_parsons_converter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/parsons_converter */ "./resources/js/lib/parsons_converter.js");
/* harmony import */ var _parsons_lib_ParsonsWidget__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../parsons_lib/ParsonsWidget */ "./resources/js/parsons_lib/ParsonsWidget.js");
...
function buildParsonString(parsonObject) {
  var parsonString = "";
  parsonObject["assignment"].forEach(function (parsonRule) {
    console.log(parsonRule);
    parsonString += "".concat(' '.repeat(parsonRule["ident"])).concat(parsonRule["rule"], " ").concat(parsonRule["distractor"] ? " #distractor" : "", "\n");
  }); // console.log(parsonString);
...
function convertParsonString(parsonString) {
  ...
  parsonString.split("\n").forEach(function (row) {
    ...
    var distractor = row.search("#distractor") !== -1;
...
$(document).ready(function () {
  var parson = new _parsons_lib_ParsonsWidget__WEBPACK_IMPORTED_MODULE_1__["default"]({
    'sortableId': 'sortable',
  ...
  var parsonObject = _lib_parsons_converter__WEBPACK_IMPORTED_MODULE_0__["default"].convertParsonString(initial);
  var parsonString = _lib_parsons_converter__WEBPACK_IMPORTED_MODULE_0__["default"].buildParsonString(parsonObject);
...
/***/ 5:
/*!**********************************************************!*\
  !*** multi ./resources/js/parsons_problems/swap_page.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\aurel\Documents\GitHub\ParsonProject\resources\js\parsons_problems\swap_page.js */"./resources/js/parsons_problems/swap_page.js");
